...
namespace exportaAPIS_CloudWso2
{
    class Program
    {
        ...
        {
            //ProgramKong.ExportaRolesApisDesdeJsonWso2(args);         //portal   
            //ProgramKong.CreaRolesDesdeArchivo(args); //portal
            ...
            //ProgramKong.ExportaAppEnConsumersAArchivo(args);
            //ProgramKong.MoverConsumersCustomIdAName(args);
            //ProgramKong.CreaConsumersDesdeArchivo(args);
            //ProgramKong.CreaAppEnConsumersDesdeArchivo(args);
            //ProgramKong.EjecutaTestCargaTokens(args);
            //ProgramKong.EjecutaTestCargaTokens2(args);
