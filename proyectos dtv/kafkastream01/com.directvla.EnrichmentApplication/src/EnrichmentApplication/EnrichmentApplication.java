...
public class EnrichmentApplication {
    ...
    public static void main(String[] args)  throws Exception {
        ...
        final Properties consumerAppProps = EnrichmentApplication.loadProperties(args[0]);
        ...
        //final EnrichmentApplication.ConsumerRecordsHandler<String, String> recordsHandler = new EnrichmentApplication.FileWritingRecordsHandler(Paths.get(filePath));
        final ConsumerRecordsHandler<String, String> recordsHandler = new LogWritingRecordsHandler();
        final EnrichmentApplication consumerApplication = new EnrichmentApplication(consumer, recordsHandler);
    ...
    public EnrichmentApplication(final Consumer<String, String> consumer,
