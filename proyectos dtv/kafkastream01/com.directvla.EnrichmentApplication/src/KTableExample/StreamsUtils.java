...
public class StreamsUtils {
    ...
    public static final String PROPERTIES_FILE_PATH = "configuration/dev.properties";
    ...
    public static Properties loadProperties() throws IOException {
       ...
       /* try (FileInputStream fis = new FileInputStream("configuration/dev.properties")) {
        ...
        properties.put("ktable.input.topic", "wo_state_store");
        properties.put("ktable.output.topic", "ktable-output");
